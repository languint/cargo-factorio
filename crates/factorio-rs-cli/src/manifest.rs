...
pub fn write_mod_manifests(
    ...
    let module_prefix = config.lua_module_prefix.as_deref().unwrap_or("");
...
mod tests {
    ...
    fn generates_data_lua_for_single_root_module() {
        ...
        let lua = generate_stage_entry_lua("my_mod", &modules, Stage::Data, "");
    ...
    fn generates_settings_lua() {
        ...
        let lua = generate_stage_entry_lua("my_mod", &modules, Stage::Settings, "");
